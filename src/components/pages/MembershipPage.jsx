    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      >
        <div className="bg-gradient-to-br from-primary-50 to-primary-100 p-6 rounded-xl">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm text-primary-600 font-medium">전체 강의</p>
              <p className="text-2xl font-bold text-primary-700">{courses.length}개</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-accent-50 to-accent-100 p-6 rounded-xl">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm text-accent-600 font-medium">수강 가능</p>
              <p className="text-2xl font-bold text-accent-700">멤버십+</p>
            </div>
          </div>
        </div>
      </motion.div>
      ...
      >
        {courses.length > 0 ? (
          ...
          <Empty
            title="아직 멤버십 강의가 없습니다"
            description="첫 번째 멤버십 강의를 업로드해보세요"
            actionText={canUpload ? "강의 업로드" : undefined}
